...
public class SellersServlet extends HttpServlet {
    private static final long serialVersionUID = -2735102612786892472L;
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Ορισμός της διεύθυνσης της σελίδας πωλητών που θα εμφανιστεί
        String address = "/pages/sellers.jsp";
