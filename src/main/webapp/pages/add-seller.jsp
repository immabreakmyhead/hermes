	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container">
					<div class="mt-4">
						<a href="sellers" class="btn p-3"><i class="fas fa-chevron-left mr-3"></i> Back to
							Sellers</a>
					</div>
					<h2 class="mt-4">ADD SELLER</h2>
					<form action="add-seller" method="post" class="needs-validation"
						novalidate>
						<div class="form-row">
