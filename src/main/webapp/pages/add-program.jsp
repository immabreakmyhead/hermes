...
<title>Hermes - Add Program</title>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container mt-5">
					...
					<div class="mt-4">
						<a href="program" class="btn p-3"><i class="fas fa-chevron-left mr-3"></i> Back to
							Programs</a>
					</div>
					...
					<form action="add-program" method="post">
						...
						<div class="form-group">
							<label for="benefits">Benefits:</label> <input type="text"
								class="form-control" id="benefits" name="benefits" required>
						</div>
						<div class="form-group">
							<label for="costs">Costs (€):</label> <input type="number"
								class="form-control" id="costs" name="costs" step="1"
								required>
						</div>
						<div class="form-group">
